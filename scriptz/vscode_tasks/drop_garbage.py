...
# ------------------------------------------------------------------------------------------------------------------------------
def drop_artifactz():
    artifactz_folder_path = _REPO_ROOT_PATH / 'artifactz'
    if artifactz_folder_path.exists():
        shutil.rmtree(artifactz_folder_path)
        print(f"found and dropped artifactz/ folder")
